...
export declare const bcs: {
     ...
     */
    tuple<const T extends readonly BcsType<any, any>[], const Name extends string = `(${JoinString<{ [K in keyof T]: T[K] extends BcsType<any, any, infer T_1 extends string> ? T_1 : never; }, ", ">})`>(fields: T, options?: BcsTypeOptions<{ -readonly [K_1 in keyof T]: T[K_1] extends BcsType<infer T_2, any> ? T_2 : never; }, { [K_1 in keyof T]: T[K_1] extends BcsType<any, infer T_2> ? T_2 : never; }, Name>): BcsTuple<T, Name>;
    /**
